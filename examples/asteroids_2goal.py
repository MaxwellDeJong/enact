...
def create_trajectory(
    ...
    #policy_gen: Generator[State, Action, None],
...
def measure_policy(
  ...
  return np.mean(last_state.has_been_at_goal1 + last_state.has_been_at_goal2)
...
def plot_trajectory(
  ...
  axis.add_artist(plt.Circle(
      states.goal1_position[index][0],
      1, color='orange'))
  axis.add_artist(plt.Circle(
      states.goal2_position[index][0],
      1, color='orange'))
